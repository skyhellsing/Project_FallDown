...
namespace QFramework.Pro
{
    ...
    public class ClassGraph : IMGUIGraph
    {
        /// <summary>
        /// 将脚本解析成图
        ...
        public void Parse()
        {
            ...
            IMGUIGraphWindow.OpenWithGraph(this);
        }


        int RenderClassTree(List<ClassTreeNode> treeNodes, ClassDB classDB, int x, int y,
            IMGUIGraphNodePort parentNodeChildrenPort = null)
        {
    ...
    public class ClassGraphInspector : IMGUIGlobalGraphInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            foreach (var node in target.As<ClassGraph>().nodes.Where(n => n is ClassNode))
            {
                ...
                if (GUILayout.Button(mGUIContent, GUILayout.Width(GUIStyle.none.CalcSize(mGUIContent).x + 10)))
                {
                    ...
                    IMGUIGraphWindow.OpenWithGraph(node.graph).Home();
                }
