...
namespace QFramework.Pro
{
    ...
    /// </summary>
    [CreateNodeMenu("")]
    public class ClassNode : IMGUIGraphNode
    {
        ...
        /// <returns></returns>
        public override object GetValue(IMGUIGraphNodePort port)
        {
    ...
    public class ClassNodeInspector : IMGUIGlobalGraphNodeInspector
    {
    ...
    public class ClassNodeEditor : IMGUIGraphNodeEditor
    {
        ...
        public override void OnBodyGUI()
        {
            ...
            while (iterator.NextVisible(enterChildren))
            {
                ...
                IMGUIGraphGUILayout.PropertyField(iterator, GUIContent.none, true);
            }
            ...
            foreach (IMGUIGraphNodePort dynamicPort in target.DynamicPorts)
            {
                ...
                // 不渲染文本
                IMGUIGraphGUILayout.PortField(GUIContent.none, dynamicPort);
            }
            ...
            if (node.ClassInfo.Comment.Content.IsNotNullAndEmpty())
            {
                ...
                GUILayout.Label(ClassGraphLocale.Description, IMGUIGraphResources.styles.nodeLabel);
                ...
                if (node.ClassInfo.Comment.Content.IsNotNullAndEmpty())
                {
                    GUILayout.Label(node.ClassInfo.Comment.Content, IMGUIGraphResources.styles.nodeLabel);
                }
            ...
            {
                GUILayout.Space(10);
                GUILayout.Label(ClassGraphLocale.Properties, IMGUIGraphResources.styles.nodeLabel);
                GUILayout.Space(2);
                ...
                foreach (var property in node.ClassInfo.Properties)
                {
                    ...
                    {
                        GUILayout.Label(property.Comment.Content, IMGUIGraphResources.styles.nodeLabel);
                    }

                    GUILayout.BeginHorizontal();
                    GUILayout.Label(property.ToString(), IMGUIGraphResources.styles.nodeLabel);
                    GUILayout.FlexibleSpace();
                    if (GUILayout.Button(ClassGraphLocale.See))
                    {
                        var monoScript = AssetDatabase.LoadAssetAtPath<MonoScript>(node.ClassInfo.FilePath);
            ...
            {
                GUILayout.Space(10);
                GUILayout.Label(ClassGraphLocale.Field, IMGUIGraphResources.styles.nodeLabel);
                GUILayout.Space(2);
                ...
                foreach (var fieldInfo in node.ClassInfo.Fields)
                {
                    ...
                    {
                        GUILayout.Label(fieldInfo.Comment.Content, IMGUIGraphResources.styles.nodeLabel);
                    }

                    GUILayout.BeginHorizontal();
                    GUILayout.Label(fieldInfo.ToString(), IMGUIGraphResources.styles.nodeLabel);
                    GUILayout.FlexibleSpace();
                    if (GUILayout.Button(ClassGraphLocale.See))
                    {
                        var monoScript = AssetDatabase.LoadAssetAtPath<MonoScript>(node.ClassInfo.FilePath);
            ...
            GUILayout.Space(10);
            GUILayout.Label(ClassGraphLocale.Methods, IMGUIGraphResources.styles.nodeLabel);
            GUILayout.Space(2);
            ...
            foreach (var method in node.ClassInfo.Methods.Where(m => m.AccessType == AccessType.Public))
            {
                ...
                {
                    GUILayout.Label(method.Comment.Content, IMGUIGraphResources.styles.nodeLabel);
                }

                GUILayout.BeginHorizontal();
                GUILayout.Label(method.ToString(), IMGUIGraphResources.styles.nodeLabel);
                GUILayout.FlexibleSpace();
                if (GUILayout.Button(ClassGraphLocale.See))
                {
                    var monoScript = AssetDatabase.LoadAssetAtPath<MonoScript>(node.ClassInfo.FilePath);
        ...
        public static int CalcWidth(ClassInfo classInfo)
        {
            ...
            void CalcSize(string content)
            {
                ...
                var size = IMGUIGraphResources.styles.nodeLabel.CalcSize(guiContent);
                if (size.x + 80 > width)
                {
                    width = (int)size.x + 80;
                }
