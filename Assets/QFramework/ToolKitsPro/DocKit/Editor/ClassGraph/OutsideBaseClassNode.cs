...
{
    [CreateNodeMenu("")]
    public class OutsideBaseClassNode : IMGUIGraphNode
    {
        [SerializeField]
        [HideInInspector]
        public string Name;
    ...
    [IMGUIGraphNodeEditor.CustomNodeEditorAttribute(typeof(OutsideBaseClassNode))]
    public class OutsideBaseClassNodeEditor : IMGUIGraphNodeEditor
    {
